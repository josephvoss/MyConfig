...
Key=dKiNPj47pbLA_LKZMVzKir31seHUSDLP8N5
Secret=LKZRZhtHvg5kkeckoBEczd
...
SuccessExec='echo $(date): Public IP updated to ${PublicIP} | mail -s "Server.jvoss14.com IP Changed" josephvoss14@gmail.com'
...
FailedExec='echo Failed with reason ${Update} | mail -s "Server.jvoss14.com is down!" josephvoss14@gmail.com'
# End settings
